...
export default function FilterPanel({ filters, setFilters }: { filters: FilterState; setFilters: Dispatch<SetStateAction<FilterState>> }) {
  ...
  return (
    <Card className="p-4 space-y-4">
      ...
      <div>
        ...
        <Select
          value={filters.area}
          onValueChange={(value: string) => setFilters({ ...filters, area: value })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
