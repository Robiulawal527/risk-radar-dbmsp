...
export default function AdminDashboard() {
  ...
  const [editingCrime, setEditingCrime] = useState<any | null>(null);
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (editingCrime) {
      ...
      const newCrime = {
        ...
        lat: dhakaAreas.find(a => a.name === formData.area)?.lat ?? 0,
        lng: dhakaAreas.find(a => a.name === formData.area)?.lng ?? 0,
