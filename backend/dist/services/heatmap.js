...
async function getHeatmapData(filter) {
    ...
    return (0, cache_js_1.cached)(cacheKey, async () => {
        ...
        const crimes = await (0, database_1.query)(`SELECT latitude, longitude, severity FROM "Crime" ${where} ${limitClause}`, params);
        return crimes
    ...
    }, { ttlMs: cache_js_1.CACHE_TTL.HEATMAP });
}
