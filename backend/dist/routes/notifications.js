...
const notificationService = __importStar(require("../services/notification.js"));
...
exports.notificationsRouter.get('/', (0, async_handler_js_1.asyncHandler)(async (req, res) => {
    const notifications = await notificationService.getUserNotifications(req.user.id);
    res.json({ success: true, data: notifications });
}));
exports.notificationsRouter.put('/read-all', (0, async_handler_js_1.asyncHandler)(async (req, res) => {
