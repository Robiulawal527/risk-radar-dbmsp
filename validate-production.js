...
const rootOrGuidelines = (filename) =>
  fs.existsSync(filename) || fs.existsSync(path.join('guidelines', filename));
...
check(
  'README.md exists',
  rootOrGuidelines('README.md'),
  'README.md not found (root or guidelines/)'
);

check(
  'PRODUCTION_READY.md exists',
  rootOrGuidelines('PRODUCTION_READY.md'),
  'PRODUCTION_READY.md not found (root or guidelines/)'
);

check(
  'TESTING_CHECKLIST.md exists',
  rootOrGuidelines('TESTING_CHECKLIST.md'),
  'TESTING_CHECKLIST.md not found (root or guidelines/)'
);

check(
  'FINAL_DEPLOYMENT_GUIDE.md exists',
  rootOrGuidelines('FINAL_DEPLOYMENT_GUIDE.md'),
  'FINAL_DEPLOYMENT_GUIDE.md not found (root or guidelines/)'
);
